...
defineProps({
  ...
  waitingCount: { type: Number, default: 0 } // Добавили пропс для защиты от дурака
});
...
<style scoped>
/* Твои стили остаются как были */
.admin-panel { background: var(--card-bg); padding: 1.5rem; border-radius: var(--border-radius); border-top: 4px solid var(--primary); margin-top: 1rem; }
